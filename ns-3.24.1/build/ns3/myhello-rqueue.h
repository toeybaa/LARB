 ...
 */
#ifndef MYHELLO_RQUEUE_H
#define MYHELLO_RQUEUE_H
...
/**
 * \ingroup myhello
 * \brief MYHELLO route request queue
 * 
 * Since MYHELLO is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
